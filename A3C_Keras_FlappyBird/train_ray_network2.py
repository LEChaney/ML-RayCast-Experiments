...
LOSS_CLIPPING = 0.2
NUM_RAYS = 5
NUM_ACTIONS = NUM_RAYS + 3
ACTION_STATE_SIZE = NUM_RAYS * 3 + 3
RAY_START_VEL = 15
RAY_ANGLE_VEL = 0.05 * np.pi
# LOOK_SPEED = 0.1
# TEMPERATURE = 0
# TEMP_INCR = 1e-6
...
def runprocess(thread_id, s_t, s_r_t):
	...
	while t-t_start < T_MAX and terminal == False:
		...
		# ray_starts = (actions[:2] + 1) / 2 * current_frame.shape[0:2]
		# ray_angles = actions[2:] * np.pi
