...
# summary_writer = tf.summary.FileWriter("logs/look/" + now, tf.get_default_graph())
...
model = buildmodel()
model.load_weights("saved_models/look/model_updates8520")
...
while True:	
	...
	# 	model.save("saved_models/look/model_updates" +	str(EPISODE)) 
	EPISODE += EPOCHS
