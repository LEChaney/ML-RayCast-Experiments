...
summary_writer = tf.summary.FileWriter("logs/ray_abs/" + now, tf.get_default_graph())
...
while True:	
	...
	if EPISODE % (20 * EPOCHS) == 0: 
		action_model.save("saved_models/ray_abs/action_model_updates" + str(EPISODE))
		ray_model.save("saved_models/ray_abs/ray_model_updates" + str(EPISODE))
		critic_model.save("saved_models/ray_abs/critic_model_update" + str(EPISODE))
	EPISODE += EPOCHS
